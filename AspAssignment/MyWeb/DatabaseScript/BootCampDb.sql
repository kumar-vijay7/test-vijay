...
USE [BootCamp2020]
GO
/****** Object:  Table [dbo].[TBL_EMPLOYEES]    Script Date: 03-03-2020 15:25:18 ******/
SET ANSI_NULLS ON
GO
...
GO
INSERT [dbo].[TBL_EMPLOYEES] ([EMP_ID], [EMP_Name], [EMP_DOB], [EMP_SALARY], [Manager_Id], [IsTrainer]) VALUES (105, N'Vijay', CAST(N'1993-11-22T00:00:00.0000000' AS DateTime2), 10000.0000, 103, 0)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SELF_JOIN]    Script Date: 03-03-2020 15:25:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_FindeMentor]    Script Date: 03-03-2020 15:25:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
